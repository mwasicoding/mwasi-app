...
<head>
    ...
    <title>Modify Product - Master Console</title>
    ...
    <div class="max-w-2xl mx-auto">
        ...
        <header class="mb-8 pb-5 border-b border-gray-900">
            <div class="flex items-center gap-2 text-xs text-gray-500 font-semibold uppercase tracking-wider mb-1">
                ...
                <span>&rarr;</span>
                <span class="text-gray-400">Modify Item</span>
            </div>
            <h1 class="text-2xl font-black tracking-tight text-white uppercase">Modify Stock Details</h1>
        </header>
        ...
        <div class="bg-gray-900/20 border border-gray-900 rounded-2xl p-6 backdrop-blur-md shadow-2xl">
            <form action="{{ route('merchant.products.update', $product->id) }}" method="POST" class="space-y-5">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" id="wholesale_cost" name="wholesale_cost" value="{{ old('wholesale_cost', $product->buying_price) }}" min="0" required
                    ...
                    <div>
                        ...
                        <input type="number" id="selling_price" name="selling_price" value="{{ old('selling_price', $product->selling_price) }}" min="0" required
                            class="w-full bg-gray-950 border border-gray-800 rounded-xl px-4 py-3 text-sm text-white font-mono placeholder-gray-600 focus:outline-none focus:border-blue-500 transition">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        <label for="stock_quantity" class="block text-xs font-bold uppercase tracking-wider text-gray-400 mb-2">Current Stock Level <span class="text-red-500">*</span></label>
